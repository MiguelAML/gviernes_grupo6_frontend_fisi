                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: const [
                        ...
                        TextFrave(
                            text: 'Sigue esta cuenta para poder ver sus fotos.',
                            color: Colors.grey,
                            fontSize: 16),
                      ],
                    )
      ...
      children: [
        ...
        Center(
            child: BlocBuilder<UserBloc, UserState>(
                builder: (_, state) => (state.user?.username != null)
                    ? const TextFrave(
                        text: 'FISI', fontSize: 22, fontWeight: FontWeight.w500)
        ...
        Center(
            child: BlocBuilder<UserBloc, UserState>(
                builder: (_, state) => (state.user?.username != null)
                    ? const TextFrave(
                        text: '18200123', fontSize: 17, color: Colors.grey)
                    : const CircularProgressIndicator())),
      ],
    );
  }

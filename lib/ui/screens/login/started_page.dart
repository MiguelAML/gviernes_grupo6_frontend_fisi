        ...
        child: Column(
          children: [
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const TextFrave(text: ' Estudiantil', fontSize: 17)
                ],
              ),
            ),
            Expanded(
            ...
            const Padding(
              ...
              child: TextFrave(
                text:
                    'El mejor lugar para escribir historias y compartir tus experiencias.',
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(12.0),
                    border: Border.all(
                        color: ColorsFrave.secundaryColorFrave, width: 1.5)),
                child: TextButton(
                  child: const TextFrave(
                      text: 'Registrate',
                      color: ColorsFrave.secundaryColorFrave,
